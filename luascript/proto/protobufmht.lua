...
M.MHT_BATTLE_EXECUTE_REQ = 20008 -- P_BattleExecuteReq 战斗执行请求 / 战报查询(设置 report_key 时为查询)
M.MHT_BATTLE_EXECUTE_RES = 20009 -- P_BattleExecuteRes 战斗执行返回
M.MHT_BATTLE_CANCEL_REQ = 20010 -- P_BattleCancelReq 战斗取消请求
M.MHT_BATTLE_QUERY_REQ = 20011 -- P_BattleQueryReq 战斗查询请求
M.MHT_BATTLE_QUERY_RES = 20012 -- P_BattleQueryRes 战斗查询返回
M.MHT_BATTLE_CS_SERVER_REGISTER = 20013 -- P_BattleCsServerRegister C++战斗服注册
